...
# 
# 
# This is a machine learning model that can predict the poverty level of households using both individual and household characteristics. 
# 
...
# 
# For multi-class problems, we have to average the F1 scores for each class. The macro F1 score averages the F1 score for each class _without taking into account label imbalances_. 
# 
...
cmap = discrete_cmap(3, base_cmap = plt.cm.RdYlBu)
...
for method, name in zip([#umap, 
    ...
    fig.colorbar(p, aspect = 3, ticks = [1, 2, 3, #4
                                        ])
